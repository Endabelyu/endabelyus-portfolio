...
export const projects: Project[] = [
  {
    ...
    result: 'Live since Feb 2026, replacing spreadsheet workflow with full order traceability at one branch.',
  ...
  },
  {
    ...
    result: 'Full-stack PWA in personal daily use, with MFA and CI/CD to a self-hosted VPS.',
  ...
  },
  {
    ...
    result: 'Spotify integration, Pomodoro timer, and cloud sync, live and open source.',
  ...
  },
  {
    ...
    features: ['Member records and registration management', 'Full-stack on Cloudflare Workers: React Router v7 frontend with a Hono API', 'PostgreSQL (Neon) via Prisma, file storage on Cloudflare R2, payments via Midtrans', 'Secure auth with Better Auth and a typed OpenAPI contract', 'Currently rolling out to real members'],
  ...
  },
  {
    ...
    features: ['Patient management with linked prescription history', 'POS lifecycle state machine (draft to in-lab to dispensed)', 'Multi-branch inventory with stock transfers', 'Fractional down-payments and BPJS integration with audit trails'],
  ...
  {
    slug: 'mycuci', name: 'MyCuci Laundry', featured: true, status: 'Live',
